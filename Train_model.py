...
class TrainAutoGluon:
    ...
    def run_pipeline(self, cluster="No cluster", num_features=0,eval_metric='roc_auc',sample_weight ='auto_weight',presets='best_quality',imbalanced = None,verbosity = 0,time_limit=3000):
        """
